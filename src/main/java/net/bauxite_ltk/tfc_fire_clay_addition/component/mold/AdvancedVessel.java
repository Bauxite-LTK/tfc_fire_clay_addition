package net.bauxite_ltk.tfc_fire_clay_addition.component.mold;
...
public class AdvancedVessel implements IMold, ItemContainer, FluidContainer, HeatContainer {
    ...
    public AdvancedVessel(ItemStack stack, ContainerInfo containerInfo)
    {
        this.stack = stack;
        this.containerInfo = containerInfo;
        this.vessel = Objects.requireNonNull(stack.get(TFCFCAComponents.ADVANCED_VESSEL));
    ...
    public int fill(FluidStack input, FluidAction action)
    {
        ...
        else
        {
            ...
            stack.set(TFCFCAComponents.ADVANCED_VESSEL, vessel = vessel.with(newContent));
            return result;
        }
    }
    ...
    {
        stack.set(TFCFCAComponents.ADVANCED_VESSEL, this.vessel = vessel);
        updateHeatCapacity();
    }
